...
backgroud = pygame.image.load(r"C:\Users\Admin\OneDrive\Рабочий стол\PP labs\AnimatedStreet.png")
...
backgroud_music = pygame.mixer.music.load(r"C:\Users\Admin\OneDrive\Рабочий стол\PP labs\background.wav")
